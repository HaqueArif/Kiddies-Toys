                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            {user ? <Link to="/login" onClick={handleLogOut} className="btn bg-orange-400 border-none">Logout</Link> : <Link to="/login" className="btn border-none bg-orange-400">Login</Link>}
                        </ul>
                    </div>
